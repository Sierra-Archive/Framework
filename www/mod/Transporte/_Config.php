...
$configMenu = function () {
    return Array(
        ...
        'Autonômos'=>Array(
            ...
            'Filhos'                => Array(__('Dicas de Estradas')=>Array(
            ...
            'Img'                   => '',
            'Icon'                  => 'road',
            'Filhos'                => Array(__('Propostas Fechadas')=>Array(
...
$config_Permissoes = function () {
    return Array(
        Array(
            ...
            'End'                   => 'Transporte/Transportadora/Painel', // Endereco da url de permissão
        ...
        Array(
            ...
            'End'                   => 'Transporte/Transportadora/Transportadoras', // Endereco da url de permissão
            'Modulo'                => 'Transporte', // Modulo Referente
            'SubModulo'             => 'Transportadora',   // Submodulo Referente
            ...
            'End'                   => 'Transporte/Fornecedor/Painel', // Endereco da url de permissão
            'Modulo'                => 'Transporte', // Modulo Referente
        ...
        Array(
            ...
            'End'                   => 'Transporte/Fornecedor/Fornecedores', // Endereco da url de permissão
            'Modulo'                => 'Transporte', // Modulo Referente
            'SubModulo'             => 'Fornecedor',   // Submodulo Referente
            ...
            'End'                   => 'Transporte/Armazem/Painel', // Endereco da url de permissão
            'Modulo'                => 'Transporte', // Modulo Referente
        ...
        Array(
            ...
            'End'                   => 'Transporte/Armazem/Armazens', // Endereco da url de permissão
            'Modulo'                => 'Transporte', // Modulo Referente
            'SubModulo'             => 'Armazem',   // Submodulo Referente
        ...
        Array(
            ...
            'End'                   => 'Transporte/Caminhoneiro/Painel', // Endereco da url de permissão
            'Modulo'                => 'Transporte', // Modulo Referente
        ...
        Array(
            ...
            'End'                   => 'Transporte/Caminhoneiro/Caminhoneiros', // Endereco da url de permissão
            'Modulo'                => 'Transporte', // Modulo Referente
            'SubModulo'             => 'Caminhoneiro',   // Submodulo Referente
        ...
        Array(
            ...
            'End'                   => 'Transporte/Estrada/Estradas', // Endereco da url de permissão
            'Modulo'                => 'Transporte', // Modulo Referente
        ...
        Array(
            ...
            'End'                   => 'Transporte/Estrada/Estradas_Add', // Endereco da url de permissão
            'Modulo'                => 'Transporte', // Modulo Referente
        ...
        Array(
            ...
            'End'                   => 'Transporte/Estrada/Estradas_Edit', // Endereco da url de permissão
            'Modulo'                => 'Transporte', // Modulo Referente
            'SubModulo'             => 'Estrada',// Submodulo Referente
        ...
        Array(
            ...
            'End'                   => 'Transporte/Estrada/Estradas_Del', // Endereco da url de permissão
            'Modulo'                => 'Transporte', // Modulo Referente
            'SubModulo'             => 'Estrada',   // Submodulo Referente
        ...
        Array(
            ...
            'End'                   => 'Transporte/Pedido/Trans_Ped_Aceitas', // Endereco da url de permissão
            'Modulo'                => 'Transporte', // Modulo Referente
        ...
        Array(
            ...
            'End'                   => 'Transporte/Pedido/Trans_Ped_Novas', // Endereco da url de permissão
            'Modulo'                => 'Transporte', // Modulo Referente
            'SubModulo'             => 'Pedido',   // Submodulo Referente
        ...
        Array(
            ...
            'End'                   => 'Transporte/Pedido/Trans_Ped_Minhas', // Endereco da url de permissão
            'Modulo'                => 'Transporte', // Modulo Referente
            'SubModulo'             => 'Pedido',   // Submodulo Referente
        ...
        Array(
            ...
            'End'                   => 'Transporte/Pedido/Trans_Ped_Novas_Aceitar', // Endereco da url de permissão
            'Modulo'                => 'Transporte', // Modulo Referente
            'SubModulo'             => 'Pedido',   // Submodulo Referente
        ...
        Array(
            ...
            'End'                   => 'Transporte/Pedido/Trans_Ped_Add', // Endereco da url de permissão
            'Modulo'                => 'Transporte', // Modulo Referente
            'SubModulo'             => 'Pedido',   // Submodulo Referente
        ...
        Array(
            ...
            'End'                   => 'Transporte/Pedido/Trans_Ped_Del', // Endereco da url de permissão
            'Modulo'                => 'Transporte', // Modulo Referente
            'SubModulo'             => 'Pedido',   // Submodulo Referente
        ...
        Array(
            ...
            'End'                   => 'Transporte/Pedido/Trans_Sol_Del', // Endereco da url de permissão
            'Modulo'                => 'Transporte', // Modulo Referente
            'SubModulo'             => 'Pedido',   // Submodulo Referente
        ...
        Array(
            ...
            'End'                   => 'Transporte/Pedido/Trans_Sol_Add', // Endereco da url de permissão
            'Modulo'                => 'Transporte', // Modulo Referente
            'SubModulo'             => 'Pedido',   // Submodulo Referente
        ...
        Array(
            ...
            'End'                   => 'Transporte/Pedido/Trans_Sol_PedAceitos', // Endereco da url de permissão
            'Modulo'                => 'Transporte', // Modulo Referente
            'SubModulo'             => 'Pedido',   // Submodulo Referente
        ...
        Array(
            ...
            'End'                   => 'Transporte/Pedido/Trans_Sol_PedPendente', // Endereco da url de permissão
            'Modulo'                => 'Transporte', // Modulo Referente
            'SubModulo'             => 'Pedido',   // Submodulo Referente
        ...
        Array(
            ...
            'End'                   => 'Transporte/Pedido/Trans_Sol_PedRecusados', // Endereco da url de permissão
            'Modulo'                => 'Transporte', // Modulo Referente
            'SubModulo'             => 'Pedido',   // Submodulo Referente
        ...
        Array(
            ...
            'End'                   => 'Transporte/Pedido/Trans_Sol_Solicitacoes', // Endereco da url de permissão
            'Modulo'                => 'Transporte', // Modulo Referente
            'SubModulo'             => 'Pedido',   // Submodulo Referente
        ...
        Array(
            ...
            'End'                   => 'Transporte/Pedido/Caminho_Ped_Aceitas', // Endereco da url de permissão
            'Modulo'                => 'Transporte', // Modulo Referente
            'SubModulo'             => 'Pedido',   // Submodulo Referente
        ...
        Array(
            ...
            'End'                   => 'Transporte/Pedido/Caminho_Ped_Novas', // Endereco da url de permissão
            'Modulo'                => 'Transporte', // Modulo Referente
            'SubModulo'             => 'Pedido',   // Submodulo Referente
        ...
        Array(
            ...
            'End'                   => 'Transporte/Pedido/Caminho_Ped_Minhas', // Endereco da url de permissão
            'Modulo'                => 'Transporte', // Modulo Referente
            'SubModulo'             => 'Pedido',   // Submodulo Referente
        ...
        Array(
            ...
            'End'                   => 'Transporte/Pedido/Caminho_Ped_Novas_Aceitar', // Endereco da url de permissão
            'Modulo'                => 'Transporte', // Modulo Referente
            'SubModulo'             => 'Pedido',   // Submodulo Referente
        ...
        Array(
            ...
            'End'                   => 'Transporte/Pedido/Caminho_Ped_Add', // Endereco da url de permissão
            'Modulo'                => 'Transporte', // Modulo Referente
            'SubModulo'             => 'Pedido',   // Submodulo Referente
        ...
        Array(
            ...
            'End'                   => 'Transporte/Pedido/Caminho_Ped_Del', // Endereco da url de permissão
            'Modulo'                => 'Transporte', // Modulo Referente
            'SubModulo'             => 'Pedido',   // Submodulo Referente
        ...
        Array(
            ...
            'End'                   => 'Transporte/Pedido/Caminho_Sol_Del', // Endereco da url de permissão
            'Modulo'                => 'Transporte', // Modulo Referente
            'SubModulo'             => 'Pedido',   // Submodulo Referente
        ...
        Array(
            ...
            'End'                   => 'Transporte/Pedido/Caminho_Sol_Add', // Endereco da url de permissão
            'Modulo'                => 'Transporte', // Modulo Referente
            'SubModulo'             => 'Pedido',   // Submodulo Referente
        ...
        Array(
            ...
            'End'                   => 'Transporte/Pedido/Caminho_Sol_PedAceitos', // Endereco da url de permissão
            'Modulo'                => 'Transporte', // Modulo Referente
            'SubModulo'             => 'Pedido',   // Submodulo Referente
        ...
        Array(
            ...
            'End'                   => 'Transporte/Pedido/Caminho_Sol_PedPendente', // Endereco da url de permissão
            'Modulo'                => 'Transporte', // Modulo Referente
            'SubModulo'             => 'Pedido',   // Submodulo Referente
        ...
        Array(
            ...
            'End'                   => 'Transporte/Pedido/Caminho_Sol_PedRecusados', // Endereco da url de permissão
            'Modulo'                => 'Transporte', // Modulo Referente
            'SubModulo'             => 'Pedido',   // Submodulo Referente
        ...
        Array(
            ...
            'End'                   => 'Transporte/Pedido/Caminho_Sol_Solicitacoes', // Endereco da url de permissão
            'Modulo'                => 'Transporte', // Modulo Referente
            'SubModulo'             => 'Pedido',   // Submodulo Referente
        ...
        Array(
            ...
            'End'                   => 'Transporte/Pedido/Arma_Ped_Aceitas', // Endereco da url de permissão
            'Modulo'                => 'Transporte', // Modulo Referente
            'SubModulo'             => 'Pedido',   // Submodulo Referente
        ...
        Array(
            ...
            'End'                   => 'Transporte/Pedido/Arma_Ped_Novas', // Endereco da url de permissão
            'Modulo'                => 'Transporte', // Modulo Referente
            'SubModulo'             => 'Pedido',   // Submodulo Referente
        ...
        Array(
            ...
            'End'                   => 'Transporte/Pedido/Arma_Ped_Minhas', // Endereco da url de permissão
            'Modulo'                => 'Transporte', // Modulo Referente
            'SubModulo'             => 'Pedido',   // Submodulo Referente
        ...
        Array(
            ...
            'End'                   => 'Transporte/Pedido/Arma_Ped_Novas_Aceitar', // Endereco da url de permissão
            'Modulo'                => 'Transporte', // Modulo Referente
            'SubModulo'             => 'Pedido',   // Submodulo Referente
        ...
        Array(
            ...
            'End'                   => 'Transporte/Pedido/Arma_Ped_Add', // Endereco da url de permissão
            'Modulo'                => 'Transporte', // Modulo Referente
            'SubModulo'             => 'Pedido',   // Submodulo Referente
        ...
        Array(
            ...
            'End'                   => 'Transporte/Pedido/Arma_Ped_Del', // Endereco da url de permissão
            'Modulo'                => 'Transporte', // Modulo Referente
            'SubModulo'             => 'Pedido',   // Submodulo Referente
        ...
        Array(
            ...
            'End'                   => 'Transporte/Pedido/Arma_Sol_Del', // Endereco da url de permissão
            'Modulo'                => 'Transporte', // Modulo Referente
            'SubModulo'             => 'Pedido',   // Submodulo Referente
        ...
        Array(
            ...
            'End'                   => 'Transporte/Pedido/Arma_Sol_Add', // Endereco da url de permissão
            'Modulo'                => 'Transporte', // Modulo Referente
            'SubModulo'             => 'Pedido',   // Submodulo Referente
        ...
        Array(
            ...
            'End'                   => 'Transporte/Pedido/Arma_Sol_PedAceitos', // Endereco da url de permissão
            'Modulo'                => 'Transporte', // Modulo Referente
            'SubModulo'             => 'Pedido',   // Submodulo Referente
        ...
        Array(
            ...
            'End'                   => 'Transporte/Pedido/Arma_Sol_PedPendente', // Endereco da url de permissão
            'Modulo'                => 'Transporte', // Modulo Referente
            'SubModulo'             => 'Pedido',   // Submodulo Referente
        ...
        Array(
            ...
            'End'                   => 'Transporte/Pedido/Arma_Sol_PedRecusados', // Endereco da url de permissão
            'Modulo'                => 'Transporte', // Modulo Referente
            'SubModulo'             => 'Pedido',   // Submodulo Referente
        ...
        Array(
            ...
            'End'                   => 'Transporte/Pedido/Arma_Sol_Solicitacoes', // Endereco da url de permissão
            'Modulo'                => 'Transporte', // Modulo Referente
            'SubModulo'             => 'Pedido',   // Submodulo Referente
