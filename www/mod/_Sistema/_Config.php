...
$config_Permissoes = function () {
    return Array(
        Array(
            ...
            'End'                   => '_Sistema/Admin', // Endereco da url de permissão
        ...
        Array(
            ...
            'End'                   => '_Sistema/Admin/Menus', // Endereco da url de permissão
            'Modulo'                => '_Sistema', // Modulo Referente
            'SubModulo'             => 'Admin',   // Submodulo Referente
        ...
        Array(
            ...
            'End'                   => '_Sistema/Admin/Menus_Add', // Endereco da url de permissão
            'Modulo'                => '_Sistema', // Modulo Referente
            'SubModulo'             => 'Admin',   // Submodulo Referente
        ...
        Array(
            ...
            'End'                   => '_Sistema/Admin/Menus_Edit', // Endereco da url de permissão
            'Modulo'                => '_Sistema', // Modulo Referente
            'SubModulo'             => 'Admin',// Submodulo Referente
        ...
        Array(
            ...
            'End'                   => '_Sistema/Admin/Menus_Del', // Endereco da url de permissão
            'Modulo'                => '_Sistema', // Modulo Referente
            'SubModulo'             => 'Admin',   // Submodulo Referente
        ...
        Array(
            ...
            'End'                   => '_Sistema/Admin/Configs', // Endereco da url de permissão
            'Modulo'                => '_Sistema', // Modulo Referente
            'SubModulo'             => 'Admin',   // Submodulo Referente
        ...
        Array(
            ...
            'End'                   => '_Sistema/Admin/Configs_Edit', // Endereco da url de permissão
            'Modulo'                => '_Sistema', // Modulo Referente
            'SubModulo'             => 'Admin',// Submodulo Referente
        ...
        Array(
            ...
            'End'                   => '_Sistema/Admin/Newsletter', // Endereco da url de permissão
            'Modulo'                => '_Sistema', // Modulo Referente
            'SubModulo'             => 'Admin',   // Submodulo Referente
        ...
        Array(
            ...
            'End'                   => '_Sistema/Admin/Newsletter_Add', // Endereco da url de permissão
            'Modulo'                => '_Sistema', // Modulo Referente
            'SubModulo'             => 'Admin',   // Submodulo Referente
        ...
        Array(
            ...
            'End'                   => '_Sistema/Admin/Newsletter_Edit', // Endereco da url de permissão
            'Modulo'                => '_Sistema', // Modulo Referente
            'SubModulo'             => 'Admin',// Submodulo Referente
        ...
        Array(
            ...
            'End'                   => '_Sistema/Admin/Newsletter_Del', // Endereco da url de permissão
            'Modulo'                => '_Sistema', // Modulo Referente
            'SubModulo'             => 'Admin',   // Submodulo Referente
        ...
        Array(
            ...
            'End'                   => '_Sistema/Admin/Grupos', // Endereco da url de permissão
            'Modulo'                => '_Sistema', // Modulo Referente
            'SubModulo'             => 'Admin',   // Submodulo Referente
        ...
        Array(
            ...
            'End'                   => '_Sistema/Admin/Grupos_Add', // Endereco da url de permissão
            'Modulo'                => '_Sistema', // Modulo Referente
            'SubModulo'             => 'Admin',   // Submodulo Referente
        ...
        Array(
            ...
            'End'                   => '_Sistema/Admin/Grupos_Edit', // Endereco da url de permissão
            'Modulo'                => '_Sistema', // Modulo Referente
            'SubModulo'             => 'Admin',// Submodulo Referente
        ...
        Array(
            ...
            'End'                   => '_Sistema/Admin/Grupos_Del', // Endereco da url de permissão
            'Modulo'                => '_Sistema', // Modulo Referente
            'SubModulo'             => 'Admin',   // Submodulo Referente
        ...
        Array(
            ...
            'End'                   => '_Sistema/Filial/Filial', // Endereco da url de permissão
            'Modulo'                => '_Sistema', // Modulo Referente
        ...
        Array(
            ...
            'End'                   => '_Sistema/Filial/Filial_Add', // Endereco da url de permissão
            'Modulo'                => '_Sistema', // Modulo Referente
            'SubModulo'             => 'Filial',   // Submodulo Referente
        ...
        Array(
            ...
            'End'                   => '_Sistema/Filial/Filial_Edit', // Endereco da url de permissão
            'Modulo'                => '_Sistema', // Modulo Referente
            'SubModulo'             => 'Filial',// Submodulo Referente
        ...
        Array(
            ...
            'End'                   => '_Sistema/Filial/Filial_Del', // Endereco da url de permissão
            'Modulo'                => '_Sistema', // Modulo Referente
            'SubModulo'             => 'Filial',   // Submodulo Referente
