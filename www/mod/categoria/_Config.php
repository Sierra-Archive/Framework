...
$configMenu = function () {
    return Array(
        'Administrar' => Array(
            'Filhos'                => Array(__('Categorias') =>Array(
                'Nome'                  => __('Categorias'),
...
$config_Permissoes = function () {
    return Array(
        Array(
            ...
            'End'                   => 'categoria/Admin/Categorias', // Endereco da url de permissão
        ...
        Array(
            ...
            'End'                   => 'categoria/Admin/Categorias_Add', // Endereco da url de permissão
            'Modulo'                => 'categoria', // Modulo Referente
            'SubModulo'             => 'Admin',   // Submodulo Referente
        ...
        Array(
            ...
            'End'                   => 'categoria/Admin/Categorias_Edit', // Endereco da url de permissão
            'Modulo'                => 'categoria', // Modulo Referente
            'SubModulo'             => 'Admin',// Submodulo Referente
        ...
        Array(
            ...
            'End'                   => 'categoria/Admin/Categorias_Del', // Endereco da url de permissão
            'Modulo'                => 'categoria', // Modulo Referente
            'SubModulo'             => 'Admin',   // Submodulo Referente
