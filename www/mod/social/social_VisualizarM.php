<?php
class social_VisualizarModelo extends social_Modelo
{
    ...
    public function retorna_persona($id) {
        ...
        $sql = $this->db->query('SELECT id_face, nome, fis_sexo, posicao FROM '.MYSQL_SOCIAL.' WHERE deletado!=1 AND id=\''.$id.'\' && user=\''.$usuario_id.'\' ORDER BY nome LIMIT 1');
