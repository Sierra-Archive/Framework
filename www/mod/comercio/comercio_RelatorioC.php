...
class comercio_RelatorioControle extends comercio_Controle
{
    ...
    */
    ...
    public function relatorio($data_inicial = '2015-01-01', $data_final = APP_DATA, $status = 'todas', $cliente = false, $cuidados = false)
    {
    ...
    public function relatorioProposta($datainicial = '2015-01-01', $data_final = APP_DATA, $status = 'todas', $cliente='false', $cuidados='false', $export = false)
    {
    ...
    public function grafico($data_inicial = '2015-01-01', $data_final = APP_DATA, $status = 'todas', $cliente = false, $cuidados = false, $tipo_grafico = 'mes')
    {
    ...
    '<tr>
        ...
        if ($i==0 ) {
            ...
            if ($export !== false) {
                self::Export_Todos($export, $table, __('Movimentação de Proposta/O.S'));
            } else {
