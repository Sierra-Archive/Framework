...
class comercio_RelatorioModelo extends comercio_Modelo
{
    ...
    public function relatorioProposta($datainicial = '2015-01-01', $data_final = APP_DATA, $status = 'todas', $cliente='false', $cuidados='false')
    {
        // Table's primary key
        $primaryKey = 'id';
        $table = 'Comercio_Proposta_Status';
        /*$datainicial = '2015-01-01', $data_final = APP_DATA*/
