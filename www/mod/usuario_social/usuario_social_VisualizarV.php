<?php
class usuario_social_VisualizarVisual extends usuario_social_Visual
{
    ...
    public function exibe_persona(&$persona){
        ...
        $this->blocos .= '<p class="botao"><a onclick="return popup(\'Nova Ação do Usuário\',\usuario_social/acoes/newacaouser/'.$persona['id'].'\')" href="#">Adicionar A��o</a></p>';
        $this->blocos .= '<p class="botao"><a onclick="return popup(\'Nova Ação do Usuário\',\usuario_social/acoes/newacaouser/'.$persona['id'].'\')" href="#">Subir Fotos</a></p><br>
