...
class usuario_mensagem_RelatorioControle extends usuario_mensagem_Controle
{
    ...
    */
    ...
    public function Aberto($datainicial, $datafinal) {
        ...
        $table = Array(
            __('Protocolo'), __('Cliente'), __('Assunto'), __('Mensagem'), __('Data Criação'), __('Data Ult. Mod.')/*,__('Funções')*/
        );
...
//$titulo = __('Listagem de Senhas');  //(<span id="DataTable_Contador">0</span>)
    ...
    public function Assunto($datainicial, $datafinal) {
        $table = Array(
            __('Protocolo'), __('Cliente'), __('Assunto'), __('Mensagem'), __('Tipo'), __('Data Criação'), __('Data Ult. Mod.')/*,__('Funções')*/
        );
    ...
    public function Produto($datainicial, $datafinal) {
        $table = Array(
            __('Marca'), __('Linha'), __('Produto'), __('Mensagem'), __('Data Criação'), __('Data Ult. Mod.')/*,__('Funções')*/
        );
    ...
    public function Qtd_Cidade($datainicial, $datafinal) {
        $table = Array(
            __('Cidade / UF'), __('No. de Chamados'), __('Data Criação'), __('Data Ult. Mod.')/*,__('Funções')*/
        );
    ...
    public function Qtd_Uf($datainicial, $datafinal) {
        $table = Array(
            __('Estado'), __('No. de Chamados'), __('Data Criação'), __('Data Ult. Mod.')/*,__('Funções')*/
        );
