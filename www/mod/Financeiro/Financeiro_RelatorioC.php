...
class Financeiro_RelatorioControle extends Financeiro_Controle
{
    ...
    */
    ...
    public function Relatorio($tipo_relatorio = 'Pagar', $data_inicial = '2015-01-01', $data_final = APP_DATA, $categoria = false) {
    ...
    public function Grafico_Relatorio($tipo_relatorio_Grafico = 'Pagar', $data_inicial = '2015-01-01', $data_final = APP_DATA, $categoria = false, $tipo_grafico = 'mes') {
