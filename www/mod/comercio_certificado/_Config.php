...
$configModule = function () {
    return Array(
        ...
        'Version'                   =>  '3.1.1',
        'Dependencias'              =>  Array(__('comercio'), 'usuario'),
    );
};
$configMenu = function () {
    return Array(
        'Comercial'=>Array(
            'Filhos'                => Array(__('Propostas')=>Array(
                'Nome'                  => __('Propostas'),
                'Link'                  => 'comercio_certificado/Proposta/Main',
                'Gravidade'             => 8,
                'Img'                   => 'turboadmin/m-dashboard.png',
                'Icon'                  => 'tags',
                'Filhos'                => false,
            ),__('Tipos de Produtos')=>Array(
...
$config_Permissoes = function () {
    return Array(
        Array(
            ...
            'End'                   => 'comercio_certificado/Produto', // Endereco da url de permissão
        ...
        Array(
            ...
            'End'                   => 'comercio_certificado/Produto/Produtos_Add', // Endereco da url de permissão
            'Modulo'                => 'comercio_certificado', // Modulo Referente
            'SubModulo'             => 'Produto',   // Submodulo Referente
        ...
        Array(
            ...
            'End'                   => 'comercio_certificado/Produto/Produtos_Edit', // Endereco da url de permissão
            'Modulo'                => 'comercio_certificado', // Modulo Referente
            'SubModulo'             => 'Produto',// Submodulo Referente
        ...
        Array(
            ...
            'End'                   => 'comercio_certificado/Produto/Produtos_Del', // Endereco da url de permissão
            'Modulo'                => 'comercio_certificado', // Modulo Referente
            'SubModulo'             => 'Produto',   // Submodulo Referente
        ...
        Array(
            ...
            'End'                   => 'comercio_certificado/Proposta', // Endereco da url de permissão
            'Modulo'                => 'comercio_certificado', // Modulo Referente
        ...
        Array(
            ...
            'End'                   => 'comercio_certificado/Proposta/Propostas_Add', // Endereco da url de permissão
            'Modulo'                => 'comercio_certificado', // Modulo Referente
            'SubModulo'             => 'Proposta',   // Submodulo Referente
        ...
        Array(
            ...
            'Desc'                  => '',
            'Chave'                 => 'comercio_Edit', // CHave unica nunca repete, chave primaria
            'End'                   => 'comercio_certificado/Proposta/Propostas_Edit', // Endereco da url de permissão
            'Modulo'                => 'comercio_certificado', // Modulo Referente
            'SubModulo'             => 'Proposta',// Submodulo Referente
        ...
        Array(
            ...
            'Desc'                  => '',
            'Chave'                 => 'comercio_Del', // CHave unica nunca repete, chave primaria
            'End'                   => 'comercio_certificado/Proposta/Propostas_Del', // Endereco da url de permissão
            'Modulo'                => 'comercio_certificado', // Modulo Referente
            'SubModulo'             => 'Proposta',   // Submodulo Referente
