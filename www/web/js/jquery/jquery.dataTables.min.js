...
sPagePrevDisabled:"fg-button ui-button ui-state-default ui-corner-left ui-state-disabled",sPageNextEnabled:"fg-button ui-button ui-state-default ui-corner-right",sPageNextDisabled:"fg-button ui-button ui-state-default ui-corner-right ui-state-disabled",sPageJUINext:"ui-icon ui-glyphicon-circle-arrow-e",sPageJUIPrev:"ui-icon ui-glyphicon-circle-arrow-w",sPageButton:"fg-button ui-button ui-state-default",sPageButtonActive:"fg-button ui-button ui-state-default ui-state-disabled",sPageButtonStaticDisabled:"fg-button ui-button ui-state-default ui-state-disabled",
sPageFirst:"first ui-corner-tl ui-corner-bl",sPagePrevious:"previous",sPageNext:"next",sPageLast:"last ui-corner-tr ui-corner-br",sStripeOdd:"odd",sStripeEven:"even",sRowEmpty:"dataTables_empty",sWrapper:"dataTables_wrapper",sFilter:"dataTables_filter",sInfo:"dataTables_info",sPaging:"dataTables_paginate fg-buttonset ui-buttonset fg-buttonset-multi ui-buttonset-multi paging_",sLength:"dataTables_length",sProcessing:"dataTables_processing",sSortAsc:"ui-state-default",sSortDesc:"ui-state-default",sSortable:"ui-state-default",
sSortableAsc:"ui-state-default",sSortableDesc:"ui-state-default",sSortableNone:"ui-state-default",sSortColumn:"sorting_",sSortJUIAsc:"css_right ui-icon ui-glyphicon-triangle-1-n",sSortJUIDesc:"css_right ui-icon ui-glyphicon-triangle-1-s",sSortJUI:"css_right ui-icon ui-glyphicon-carat-2-n-s",sSortJUIAscAllowed:"css_right ui-icon ui-glyphicon-carat-1-n",sSortJUIDescAllowed:"css_right ui-icon ui-glyphicon-carat-1-s",sSortJUIWrapper:"DataTables_sort_wrapper",sSortIcon:"DataTables_sort_icon",sScrollWrapper:"dataTables_scroll",
...
this.oInstance=null;this.oFeatures={bPaginate:true,bLengthChange:true,bFilter:true,bSort:true,bInfo:true,bAutoWidth:true,bProcessing:false,bSortClasses:true,bStateSave:false,bServerSide:false,bDeferRender:false};this.oScroll={sX:"",sXInner:"",sY:"",bCollapse:false,bInfinite:false,iLoadGap:100,iBarWidth:0,bAutoCss:true};this.aanFeatures=[];this.oLanguage={sProcessing:Linguagem["Botoes"]['Processando'],sLengthMenu:Linguagem["DataTable"]['Mostrando'],sZeroRecords:Linguagem["DataTable"]['Sem_Resultado'],sEmptyTable:"No data available in table",
sLoadingRecords:Linguagem["Botoes"]['Carregando'],sInfo:Linguagem["Paginacao"]['Mostrando'],sInfoEmpty:Linguagem["DataTable"]['Vazio'],sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sInfoThousands:",",sSearch:Linguagem["DataTable"]['Procurar'],sUrl:"",oPaginate:{sFirst:Linguagem["Paginacao"]['Primeiro'],sPrevious:Linguagem["Paginacao"]['Anterior'],sNext:Linguagem["Paginacao"]['Proximo'],sLast:Linguagem["Paginacao"]['Ultimo']},fnInfoCallback:null};this.aoData=[];this.aiDisplay=[];this.aiDisplayMaster=[];this.aoColumns=[];this.aoHeader=[];this.aoFooter=[];this.iNextId=0;this.asDataSearch=[];this.oPreviousSearch={sSearch:"",
