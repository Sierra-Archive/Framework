...
<?php } else if ($params['Tipo']==='SelectMultiplo') { ?>
    <div class="form-group">
        ...
        <?php if ($params['Opcao']['end']!='' && $params['Opcao']['form_dependencia'] === false) { 
            if ($params['Opcao']['ColunaForm']==='horizontal') echo '</div><div class="col-md-1">';
            ?><p class="help-block"><a href="<?php echo $params['Opcao']['url']; echo $params['Opcao']['end']; ?>?formselect=<?php echo $params['Opcao']['id']; ?>&condicao=<?php echo $params['Opcao']['condicao']; ?>" style="" class="lajax btn btn-floating btn-ripple btn-primary" data-acao=""><i class="ion-android-add"></i></a></span>
            <?php
        }
    ...
    <?php } else { ?>
        <div class="form-group"<?php if ($params['Opcao']['escondido'] !== false) { ?> id="<?php echo $params['Opcao']['id']; ?>_escondendo"<?php } if ($params['Opcao']['escondido']==='apagado') { ?> style="display: none;"<?php } ?>>
            ...
            <?php if ($params['Opcao']['ColunaForm']==='horizontal') echo '<div class="col-md-9">'; ?>
                ...
                <?php if ($params['Opcao']['urlextra']!='') { ?><span class="add-on" onClick="<?php echo $params['Opcao']['urlextra']; ?>"><i class="ion-android-add"></i></span></div><?php } ?>
                <?php if (isset($params['Opcao']['Info']) && $params['Opcao']['Info']!='') { ?></div><div class="col-md-1"><p class="help-block"><?php echo $params['Opcao']['info']; ?></span><?php } ?>
...
<?php } else if ($params['Tipo']==='TextArea') { ?>
    <div class="form-group"<?php if ($params['Opcao']['escondido'] !== false) { ?> id="<?php echo $params['Opcao']['id']; ?>_escondendo"<?php } if ($params['Opcao']['escondido']==='apagado') { ?> style="display: none;"<?php } ?>>
        ...
        <?php if ($params['Opcao']['ColunaForm']==='horizontal') echo '<div class="col-md-9">'; ?>
            ...
            <?php if ($params['Opcao']['urlextra']!='') { ?><span class="add-on"><a href="<?php echo $params['Opcao']['url']; echo $params['Opcao']['urlextra']; ?>" style="" class="lajax btn btn-floating btn-ripple btn-primary" data-acao=""><i class="ion-android-add"></i></a></span><?php } ?>
...
<?php } else if ($params['Tipo']==='Select_Inicio') { ?>
    <div class="form-group"<?php if ($params['Opcao']['escondido'] !== false) { ?> id="<?php echo $params['Opcao']['id']; ?>_escondendo"<?php } if ($params['Opcao']['escondido']==='apagado') { ?> style="display: none;"<?php } ?>>
    <label class="<?php if ($params['Opcao']['ColunaForm']==='horizontal') echo 'col-md-3 control-label'; ?>" for="<?php echo $params['Opcao']['id']; ?>"><?php echo $params['Opcao']['titulo']; ?></label>
    <?php if ($params['Opcao']['ColunaForm']==='horizontal') {
        if ($params['Opcao']['end']!='' && $params['Opcao']['form_dependencia'] === false) { echo '<div class="col-md-8 col-sm-10 col-xs-9">';  }
        else { echo '<div class="col-md-9 col-xs-12">';  }
    }?>
...
<?php } else if ($params['Tipo']==='Select_Fim') { ?>   
    ...
    <?php if ($params['Opcao']['end']!='' && $params['Opcao']['form_dependencia'] === false) { 
        if ($params['Opcao']['ColunaForm']==='horizontal') echo '</div><div class="col-md-1 col-sm-2 col-xs-3">';
        ?><p style="margin-top:-3px;"><a href="<?php echo $params['Opcao']['url']; echo $params['Opcao']['end']; ?>?formselect=<?php echo $params['Opcao']['id']; ?>&condicao=<?php echo $params['Opcao']['condicao']; ?>" style="" class="lajax btn btn-floating btn-ripple btn-primary" data-acao=""><i class="ion-android-add"></i></a></span>
        <?php
    } 
    if ($params['Opcao']['ColunaForm']==='horizontal') echo '</div>'; ?>
    </div>
...
<?php } else if ($params['Tipo']==='Radio_Inicio') { ?> 
    <div class="form-group"<?php if ($params['Opcao']['escondido'] !== false) { ?> id="<?php echo $params['Opcao']['id']; ?>_escondendo"<?php } if ($params['Opcao']['escondido']==='apagado') { ?> style="display: none;"<?php } ?>>
    <label class="<?php if ($params['Opcao']['ColunaForm']==='horizontal') echo 'col-md-3 control-label'; ?>" for="<?php echo $params['Opcao']['id']; ?>"><?php echo $params['Opcao']['titulo']; ?>
    <?php if ($params['Opcao']['js']!='') { ?> <a href="#" onClick="<?php echo $params['Opcao']['js']; ?>" style="" class="lajax btn btn-floating btn-ripple btn-primary"><i class="ion-android-add"></i></a><?php } ?>
    </label>
    <?php if ($params['Opcao']['ColunaForm']==='horizontal') echo '<div class="col-md-9">'; ?>
...
<?php } else if ($params['Tipo']==='Final') { ?>        
    <?php if ($params['Opcao']['botao']!='') { ?>
        <div class="form-buttons">
            <input type="submit" class="btn btn-ripple btn-success" value="<?php echo $params['Opcao']['botao']; ?>" tabindex="<?php echo $params['TabIndex']; ?>" />
        </div>
    <?php } ?>
    </form>
        ...
        <?php if ($params['Opcao']['ColunaForm']==='horizontal') echo '<div class="col-md-9">'; ?>
            ...
            <div data-provides="fileinput" class="fileinput fileinput-new">
                ...
                <?php } ?>
                    ...
                    <a data-dismiss="fileinput" class="btn btn-default fileinput-exists" href="#"><?php _e('Remover'); ?></a>
                </div>
            </div>
