var Layout = {
    ...
    listenForMenuLayer: function () {
        $(".nav-menu").on("click", function () {
            var e = $(this),
                ...
                l = $("body"),
                o = $(".scrollable-tabs");
            t.find('[data-open-after="true"]').addClass("open"), e.hasClass("active") ? (
            e.addClass("rotating"), n.removeClass("fade-in"), i.removeClass("scaled"), setTimeout(

            function () {
                t.removeClass("active"), $.Velocity.animate(
                a.children("span"), {
                    translateZ: 0,
                    scaleX: 0,
                    scaleY: 0
            ...
            function () {
                l.addClass("disable-scroll"), s.addClass("overlay-nav active"), e.addClass("active"), t.addClass("active"), n.addClass("fade-in"), t.find('[data-open-after="true"]').parents("li").addClass("open animate"), $.Velocity.animate(
                a.children("span"), {
                    translateZ: 0,
                    scaleX: 1,
                    scaleY: 1
    ...
    listenForSearchLayer: function () {
        $(".nav-search").on("click", function () {
            ...
            }, 200)) : (Pleasure.checkTouchScreen() || Layout.settings.improvePerformance || n.addClass("scaled"), i.addClass("activating"), l.addClass("disabled"), setTimeout(function () {
    ...
    listenForUserLayer: function () {
        $(".nav-user").on("click", function () {
            ...
            }, 200)) : (Pleasure.checkTouchScreen() || Layout.settings.improvePerformance || n.addClass("scaled"), i.addClass("activating"), o.addClass("disabled"), setTimeout(function () {
    ...
    listenMenu: function () {
        $(".menu-layer a").on("click", function () {
            ...
            }, 100)) : e.parents("li").hasClass("open") ? e.parents("li").removeClass("animate open") : (a.find(".open").removeClass("animate open"), e.parents("li").addClass("open"), setTimeout(function () {
    ...
    getMessageById: function (e) {
        ...
        }, 1e3), $("body").hasClass("layout-device") && t.addClass("active")
    },
