...
<!--<ul class="currencyBox active">
    <li class="currency" id="header_currancy"> <a href="#" class="mainCurrency">Moeda: Real</a>
      <div class="currency_detial" id="currancyBox" style="display: none;"> <a href="#">£</a> <a href="#">€</a> <a href="#">$</a> </div>
    </li>
</ul>
