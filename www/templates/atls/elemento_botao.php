...
<?php }else if($params['Tipo']==='Editar'){ ?>
    <a href="<?php echo URL_PATH; echo $params['btn_add']['url']; ?>" class="btn btn-warning lajax explicar-titulo" data-confirma="Deseja Realmente Editar?" title="<?php echo $params['btn_add']['nome']; ?>" data-acao="">
