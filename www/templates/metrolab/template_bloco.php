            ...
            if($params['btn_extra']!==false){ ?>
                <?php if(is_array($params['btn_extra'])){ ?>
                    <div class="update-btn">
                        <a class="btn btn-default lajax" href="<?php echo $params['btn_extra']['link']; ?>" acao=""><i class="fa fa-<?php echo $params['btn_extra']['icon']; ?>"></i><span class="hidden-xs"> <?php echo $params['btn_extra']['nome']; ?></span></a>
                    </div>
                <?php }else{ ?>
                    <div class="update-btn">
                        <a class="btn btn-default lajax" href="#" onClick="<?php echo $params['btn_extra']; ?>" acao=""><i class="fa fa-repeat"></i><span class="hidden-xs"> <?php _e('Salvar'); ?></span></a>
                    </div>
                <?php }
            } ?>
        </div>
