<?php if( $params['Tipo']==='Entrada'){ ?>
    ...
    <?php }else{ ?>
        <form id="<?php echo $params['Opcao']['id']; ?>" class="<?php echo $params['Opcao']['class']; ?>" action="<?php echo $params['Opcao']['url']; ?>" method="post" enctype="multipart/form-data" autocomplete="<?php echo $params['Opcao']['AutoComplete']; ?>">
    <?php } ?>
...
<?php }else if($params['Tipo']==='SelectMultiplo'){ ?>
    ...
    <?php if($params['Opcao']['end']!='' && $params['Opcao']['form_dependencia']===false){ ?></div><div class="col-sm-1"><span class="help-block"><a href="<?php echo $params['Opcao']['url']; ?><?php echo $params['Opcao']['end']; ?>?formselect=<?php echo $params['Opcao']['id']; ?>&condicao=<?php echo $params['Opcao']['condicao']; ?>" style="" class="lajax btn btn-primary" acao="">+</a></span><?php } ?></div></div>
...
<?php }else if($params['Tipo']==='Conteudo'){ ?>
    <div class="form-group"<?php if($params['Opcao']['escondido']!==false){ ?> id="<?php echo $params['Opcao']['id']; ?>_escondendo"<?php } ?><?php if($params['Opcao']['escondido']==='apagado'){ ?> style="display: none;"<?php } ?>>
        <label class="col-sm-2 control-label" for="<?php echo $params['Opcao']['id']; ?>"><?php echo $params['Opcao']['titulo']; ?></label>
        <div class="col-sm-9"><?php echo $params['Opcao']['html']; ?></div>
    </div>
