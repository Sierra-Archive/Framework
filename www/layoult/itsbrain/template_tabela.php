...
<?php }else if($params['Tipo']==='Dinamica'){
        if ($params['Opcao']['Tabela']){
            ...
            $contador = 0;  ?>
            <table class="table table-hover table-striped table-bordered datatable row<?php if($params['Opcao']['Apagado1']){ ?> apagado1<?php } ?>" ordenar="<?php echo $params['Opcao']['aaSorting']; ?>"><thead><tr>
