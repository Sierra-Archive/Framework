...
<?php }else if($params['Tipo']==='SelectMultiplo'){ ?>
    ...
    <?php if($params['Opcao']['end']!='' && $params['Opcao']['form_dependencia']===false){ ?><span class="help-block"><a href="<?php echo $params['Opcao']['url']; ?><?php echo $params['Opcao']['end']; ?>?formselect=<?php echo $params['Opcao']['id']; ?>&condicao=<?php echo $params['Opcao']['condicao']; ?>" class="lajax btn btn-primary" acao="">+</a></span><?php } ?></div></div>
