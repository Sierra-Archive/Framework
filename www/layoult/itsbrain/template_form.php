<?php if( $params['Tipo']==='Entrada'){ ?>
    <?php if($params['Opcao']['end']!=''){ ?>
        <form id="<?php echo $params['Opcao']['id']; ?>" class="form-horizontal <?php echo $params['Opcao']['class']; ?>" action="<?php echo $params['Opcao']['url']; ?><?php echo $params['Opcao']['end']; ?>" method="post"  enctype="multipart/form-data" autocomplete="<?php echo $params['Opcao']['AutoComplete']; ?>">
    <?php }else{ ?>
        <form id="<?php echo $params['Opcao']['id']; ?>" class="form-horizontal <?php echo $params['Opcao']['class']; ?>" action="<?php echo $params['Opcao']['url']; ?>" method="post"  enctype="multipart/form-data" autocomplete="<?php echo $params['Opcao']['AutoComplete']; ?>">
    <?php } ?>
...
<?php }else if($params['Tipo']==='SelectMultiplo'){ ?>
    ...
    <?php if($params['Opcao']['js']!=''){ ?> <a href="#" onClick="<?php echo $params['Opcao']['js']; ?>" class="lajax btn btn-primary">+</a><?php } ?>
    </label>
    <div class="col-sm-9">
    ...
    <?php if($params['Opcao']['end']!='' && $params['Opcao']['form_dependencia']===false){ ?></div><div class="col-sm-1"><span class="help-block"><a href="<?php echo $params['Opcao']['url']; ?><?php echo $params['Opcao']['end']; ?>?formselect=<?php echo $params['Opcao']['id']; ?>&condicao=<?php echo $params['Opcao']['condicao']; ?>" class="lajax btn btn-primary" acao="">+</a></span><?php } ?></div></div>
...
<?php }else if($params['Tipo']==='Input'){ ?>
    ...
    <?php }else{ ?>
        <div class="form-group row"<?php if($params['Opcao']['escondido']!==false){ ?> id="<?php echo $params['Opcao']['id']; ?>_escondendo"<?php } ?><?php if($params['Opcao']['escondido']==='apagado'){ ?> style="display: none;"<?php } ?>>
...
<?php }else if($params['Tipo']==='Final'){ ?>        
    <?php if($params['Opcao']['botao']!=''){ ?>
        <div class="form-actions">
            <input tabindex="<?php echo $params['TabIndex']; ?>" type="submit" class="btn btn-success" value="<?php echo $params['Opcao']['botao']; ?>" />
        </div>
    <?php } ?>
    </form>
