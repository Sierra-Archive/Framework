<ul id="main-menu" class="radius-top clearfix">
    <?php foreach($params['menu']['link'] as $k=>$v){ ?>
        <li>
            <a acao="Control_Menu_Superior" href="<?php echo $params['menu']['link'][$k]; ?>" class="lajax-mesup<?php if( $params['menu']['ativo'][$k]===1){ ?> active<?php }else if(isset($params['menu']['Superior']) && $params['menu']['Superior']['ativo'][$k]===2){ ?> active submenu-active<?php } ?>">
