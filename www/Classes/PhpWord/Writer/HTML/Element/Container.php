...
class Container extends AbstractElement
{
     ...
     * @var string
     */
    protected $namespace = 'Framework\Classes\\PhpWord\\Writer\\HTML\\Element';
    ...
    public function write()
    {
        ...
        foreach ($elements as $element) {
            ...
            $writerClass = str_replace('Framework\Classes\\PhpWord\\Element', $this->namespace, $elementClass);
            if (class_exists($writerClass)) {
                /** @var \Framework\Classes\PhpWord\Writer\HTML\Element\AbstractElement $writer Type hint */
