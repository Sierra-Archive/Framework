<?php
final Class Musica_Video_DAO extends Framework\App\Dao 
{
    protected $id;
    protected $album;
    protected $artista;
    ...
    public static function Gerar_Colunas(){
        return Array(
            ...
            Array(
                ...
                'form_change'       => 'MV', // CHANGE PARA EXTRANGEIRAS -> Sigla Tabela Pai / Sigla Tabela Atual ou false
                'mysql_autoadd'     => false,
                'mysql_comment'     => false,
                'mysql_inside'      => false, // Funcao Executada quando o dado for inserido no banco de dados
                'mysql_outside'     => false, // Funcao Executada quando o dado for retirado no banco de dados
            ...
            Array(
                ...
                'mysql_default'     => 0, // valor padrao
                'mysql_primary'     => false,  // chave primaria
                'mysql_estrangeira' => 'M.id|M.nome|M.album={album}', // chave estrangeira     ligacao|apresentacao|condicao
                'mysql_autoadd'     => false,
                'mysql_comment'     => false,
                'mysql_inside'      => false, // Funcao Executada quando o dado for inserido no banco de dados
                'mysql_outside'     => false, // Funcao Executada quando o dado for retirado no banco de dados
                'perm_copia'        => false, //permissao funcional necessaria para campo 2 todos 
                'linkextra'         => 'Musica/Musica/Musicas_Add', //0 ninguem, 1 admin, 2 todos 
                'edicao'            => Array(
                    'Nome'              => __('Musica'),
                    'valor_padrao'      => false,
                    'readonly'          => false,
            ...
            Array(
                ...
                'edicao'            => Array(
                    ...
                    'select'            => array(
                        'class'             => 'obrigatorio',
                        'infonulo'          => 'Escolha se o Video fica ou não em destaque',
                        'opcoes'            => array(
                            array(
                                'value'         =>  '0',
                                'nome'          => 'Não'
