<?php
final Class Financeiro_Financa_DAO extends Framework\App\Dao 
{
    protected $id;
    protected $categoria;
    protected $valor;
    ...
    protected static $objetocarregado     = FALSE;     protected static $mysql_colunas       = FALSE;     protected static $mysql_outside       = Array();     protected static $mysql_inside        = Array(); public function __construct() {  parent::__construct(); } public static function Get_Nome() {
        return MYSQL_FINANCEIRO_FINANCAS;
    }
    /**
        ...
        return Array(
            Array(
                ...
                'edicao'            => Array(
                    ...
                    'select'             => array(
                        'class'             => 'obrigatorio',
                        'infonulo'          => 'Escolha uma Categoria de Finanças',
                    )
                )
            ),
            Array(
