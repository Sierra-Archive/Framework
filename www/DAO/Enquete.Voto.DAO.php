<?php
final Class Enquete_Voto_DAO extends Framework\App\Dao 
{
    protected $id;
    protected $enquete;
    protected $usuario;
    ...
    public static function Gerar_Colunas(){
        return Array(
            ...
            Array(
                'mysql_titulo'      => 'enquete',
                'mysql_tipovar'     => 'int', //varchar, int, 
                'mysql_tamanho'     => 11,
                'mysql_null'        => true, // true NULL, false, NOT NULL
                'mysql_default'     => false,//false -> NONE, outro -> default
                'mysql_primary'     => false, // chave primaria
                'mysql_indice_unico'=> 'usuario',
                'mysql_estrangeira' => 'E.id|E.nome', // chave estrangeira     ligacao|apresentacao|condicao
                'mysql_autoadd'     => false,
                'mysql_comment'     => false,
                'mysql_inside'      => false, // Funcao Executada quando o dado for inserido no banco de dados
                'mysql_outside'     => false, // Funcao Executada quando o dado for retirado no banco de dados
                ...
                'mysql_default'     => false,
                'mysql_primary'     => false,
                'mysql_estrangeira' => 'ER.id|ER.nome', // chave estrangeira
                'mysql_autoadd'     => false,
                'mysql_comment'     => false,
                'mysql_inside'      => false, // Funcao Executada quando o dado for inserido no banco de dados
                'mysql_outside'     => false, // Funcao Executada quando o dado for retirado no banco de dados
