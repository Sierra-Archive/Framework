...
final Class Comercio_Fornecedor_Material_DAO extends Framework\App\Dao 
{
    protected $id;
    ...
    public static function Gerar_Colunas(){
        return Array(
            ...
            Array(
                ...
                'mysql_estrangeira' => 'CF.id|CF.nome-CF.razao_social', // chave estrangeira     ligacao|apresentacao|condicao
                'mysql_autoadd'     => false,
                'mysql_comment'     => false,
                'mysql_inside'      => false, // Funcao Executada quando o dado for inserido no banco de dados
                'mysql_outside'     => false, // Funcao Executada quando o dado for retirado no banco de dados
                ...
                'mysql_default'     => false,
                'mysql_primary'     => false,
                'mysql_estrangeira' => 'C.id|C.nome|CA.mod_acc=Financeiro_Financa', // chave estrangeira
                'mysql_autoadd'     => false,
                'mysql_comment'     => false,
                'mysql_inside'      => false, // Funcao Executada quando o dado for inserido no banco de dados
                'mysql_outside'     => false, // Funcao Executada quando o dado for retirado no banco de dados
                ...
                'edicao'            => Array(
                    ...
                    'select'             => array(
                        'class'             => 'obrigatorio',
                        'infonulo'          => 'Escolha um Centro de Custo',
                    )
                )
            ),Array(
                'mysql_titulo'      => 'numero',
            ...
            Array(
                'TabelaLinkada'     => Array(
                    ...
                    'SelectMultiplo'   => Array(
                        ...
                        'Linkar'            => 'entrada', // CAmpo a ser encaixado id do pai
            ...
            Array(
                ...
                'edicao'            => Array(
                    ...
                    'aviso'             => '',
                    'formtipo'          => 'select',
                    'change'            => 'Local::Form_Change_Produto();',
                    'select'             => array(
                        'class'             => 'obrigatorio',
            ...
            Array(
                'mysql_titulo'      => 'primeiro_pagamento',
                'mysql_tipovar'     => 'date', //varchar, int, 
                'mysql_tamanho'     => 10,
                'mysql_null'        => false,
                'mysql_default'     => '0000-00-00',
