<?php
final Class Predial_Bloco_Apart_Advertencia_DAO extends Framework\App\Dao 
{
    protected $id;
    protected $bloco;
    protected $apart;
    ...
    protected $nome;
    protected $descricao;
    protected $data_acontecimento;
    protected static $objetocarregado     = false;     protected static $mysql_colunas       = false;     protected static $mysql_outside       = Array();     protected static $mysql_inside        = Array(); public function __construct() {  parent::__construct(); } public static function Get_Nome(){
        return MYSQL_PREDIAL_BLOCO_APART_ADVERTENCIA;
    }
    /**
    ...
    public static function Gerar_Colunas(){
        return Array(
            Array(
                ...
                'form_change'       => 'PBAAD', // CHANGE PARA EXTRANGEIRAS -> Sigla Tabela Pai / Sigla Tabela Atual ou false
                'mysql_autoadd'     => false,
                'mysql_comment'     => false,
                'mysql_inside'      => false, // Funcao Executada quando o dado for inserido no banco de dados
                'mysql_outside'     => false, // Funcao Executada quando o dado for retirado no banco de dados
            ...
            Array(
                ...
                'mysql_estrangeira' => 'C.id|C.nome|CA.mod_acc=predial_Advertencia', // chave estrangeira     ligacao|apresentacao|condicao
                'mysql_autoadd'     => false,
                'mysql_comment'     => false,
                'mysql_inside'      => false, // Funcao Executada quando o dado for inserido no banco de dados
                'mysql_outside'     => false, // Funcao Executada quando o dado for retirado no banco de dados
            ...
            Array(
                'mysql_titulo'      => 'data_acontecimento',
