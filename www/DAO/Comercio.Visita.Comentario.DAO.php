<?php
final Class Comercio_Visita_Comentario_DAO extends Framework\App\Dao 
{
    protected $id;
    protected $visita;
    ...
    public static function Get_Nome() {
        return MYSQL_COMERCIO_VISITA_COMENTARIO;
    }
    /**
    ...
    public static function Gerar_Colunas() {
        return Array(
            ...
            Array(
                ...
                'mysql_estrangeira' => 'CV.id|CV.clientepossivel', // chave estrangeira     ligacao|apresentacao|condicao
                'mysql_autoadd'     => false,
                'mysql_comment'     => false,
                'mysql_inside'      => false, // Funcao Executada quando o dado for inserido no banco de dados
                'mysql_outside'     => false, // Funcao Executada quando o dado for retirado no banco de dados
