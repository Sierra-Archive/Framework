<?php
final Class  Biblioteca_DAO extends Framework\App\Dao 
{
    protected $id;
    protected $parent;
    protected $nome;
    protected $end_virtual; // Endereço Virtual
    protected $ext; // Extensao
    protected $tamanho; // Extensao
    protected $tipo; //1=pasta, 2=arquivo
    protected $obs;
    protected $arquivo;
    protected $usuario;
    protected $grupo;
    // Padrao é false, ou array com os campos que nao aceita
    protected static $campos_naoaceita_config  = Array('arquivo','end_virtual','ext');
    protected static $objetocarregado     = false;     protected static $mysql_colunas       = false;     protected static $mysql_outside       = Array();     protected static $mysql_inside        = Array(); public function __construct() {  parent::__construct(); } public static function Get_Nome(){
        return MYSQL_BIBLIOTECA;
    }
    /**
    ...
    public static function Gerar_Colunas(){
        return Array(
            ...
            Array(
                ...
                'mysql_estrangeira' => 'Bi.id|Bi.nome|Bi.tipo=1', // chave estrangeira     ligacao|apresentacao|condicao
                'mysql_autoadd'     => false,
                'mysql_comment'     => false,
                'mysql_inside'      => false, // Funcao Executada quando o dado for inserido no banco de dados
                'mysql_outside'     => false, // Funcao Executada quando o dado for retirado no banco de dados
            ...
            Array(
                ...
                'mysql_default'     => false,
                'mysql_primary'     => false,
                'mysql_estrangeira' => 'SG.id|SG.nome', // chave estrangeira
                'mysql_autoadd'     => false,
                'mysql_comment'     => false,
                'mysql_inside'      => false, // Funcao Executada quando o dado for inserido no banco de dados
                'mysql_outside'     => false, // Funcao Executada quando o dado for retirado no banco de dados
