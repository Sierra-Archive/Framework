<?php
final Class Agenda_Compromisso_DAO extends Framework\App\Dao 
{
    protected $id;
    protected $motivo;
    protected $motivoid;
    ...
    protected static $objetocarregado     = false;     protected static $mysql_colunas       = false;     protected static $mysql_outside       = Array();     protected static $mysql_inside        = Array(); public function __construct() {  parent::__construct(); } public static function Get_Nome(){
        return MYSQL_AGENDA_COMPROMISSO;
    }
    /**
    ...
    public static function Gerar_Colunas(){
        return Array(
            Array(
                ...
                'linkextra'         => '', // //0 ninguem, 1 admin, 2 todos 
                'edicao'            => Array(
                    'Nome'              => __('Tipo (Mensal,anual,semanal,unico)'),
                    'Mascara'           => 'Numero',
                    'valor_padrao'      => false,
                    'readonly'          => false,
                    'aviso'             => __('Minimo 3 caracteres'),
                ...
                'edicao'            => Array(
                    ...
                    'aviso'             => '',
                    'formtipo'          => 'input',
                    'validar'           => 'Control_Layoult_Valida_Hora',
                    'input'             => array(
                        'tipo'              => 'text',
                        'class'             => 'obrigatorio  masc_hora'
                    )
                )
            ),Array(
                'mysql_titulo'      => 'dt_fim',
