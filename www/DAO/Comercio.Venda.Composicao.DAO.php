<?php
final Class Comercio_Venda_Composicao_DAO extends Framework\App\Dao 
{
    protected $id;
    protected $foto;
    protected $nome;
    ...
    protected static $objetocarregado     = FALSE;     protected static $mysql_colunas       = FALSE;     protected static $mysql_outside       = Array();     protected static $mysql_inside        = Array(); public function __construct() {  parent::__construct(); } public static function Get_Nome() {
        return MYSQL_COMERCIO_VENDA_COMPOSICAO;
    }
    /**
    ...
    public static function Gerar_Colunas() {
        return Array(
            ...
            Array(
                'TabelaLinkada'     => Array(
                    'Pai'               => 'CVCo', // TABELA que vai manipular a conexao
                    'Tabela'            => 'CVCP', // TABELA de LINK A SER CONECTADA
                    'valor_padrao'      => FALSE, // id do pai
                    'Nome'              => __('Produtos'), // Nome no FOrmulario
                    ...
                    'SelectMultiplo'   => Array(
                        ...
                        'Linkar'            => 'composicao', // CAmpo a ser encaixado id do pai
