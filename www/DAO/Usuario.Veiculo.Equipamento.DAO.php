<?php
final Class  Usuario_Veiculo_Equipamento_DAO extends Framework\App\Dao 
{
    protected $id;
    protected $categoria;
    ...
    protected static $objetocarregado     = false;     protected static $mysql_colunas       = false;     protected static $mysql_outside       = Array();     protected static $mysql_inside        = Array(); public function __construct() {  parent::__construct(); } public static function Get_Nome(){
        return MYSQL_USUARIO_VEICULO_EQUIPAMENTO;
    }
    /**
    ...
    public static function Gerar_Colunas(){
        return Array(
            ...
            Array(
                ...
                'mysql_estrangeira' => 'C.id|C.nome|CA.mod_acc=usuario_veiculo_Equipamento', // chave estrangeira     ligacao|apresentacao|condicao
                'mysql_autoadd'     => false,
                'mysql_comment'     => false,
                'mysql_inside'      => false, // Funcao Executada quando o dado for inserido no banco de dados
                'mysql_outside'     => false, // Funcao Executada quando o dado for retirado no banco de dados
                ...
                'edicao'            => Array(
                    ...
                    'select'             => array(
                        'class'             => 'obrigatorio',
                        'infonulo'          => 'Escolha um Tipo de Equipamento',
                    )
                )
            ),Array(
                ...
                'mysql_default'     => false,
                'mysql_primary'     => false,
                'mysql_estrangeira' => 'CF.id|CF.nome', // chave estrangeira
                'mysql_autoadd'     => false,
                'mysql_comment'     => false,
                'mysql_inside'      => false, // Funcao Executada quando o dado for inserido no banco de dados
                'mysql_outside'     => false, // Funcao Executada quando o dado for retirado no banco de dados
                ...
                'mysql_default'     => false,
                'mysql_primary'     => false,
                'mysql_estrangeira' => 'UVEM.id|UVEM.nome', // chave estrangeira
                'form_change'       => 'UVE', // CHANGE PARA EXTRANGEIRAS -> Sigla Tabela Pai / Sigla Tabela Atual ou false
                'mysql_autoadd'     => false,
                'mysql_comment'     => false,
                'mysql_inside'      => false, // Funcao Executada quando o dado for inserido no banco de dados
                'mysql_outside'     => false, // Funcao Executada quando o dado for retirado no banco de dados
                ...
                'mysql_default'     => false,
                'mysql_primary'     => false,
                'mysql_estrangeira' => 'UVEMO.id|UVEMO.nome|UVEMO.marca={marca}', // chave estrangeira
                ...
                'linkextra'         => '', // //0 ninguem, 1 admin, 2 todos 
                'edicao'            => Array(
                    'Nome'              => CFG_TXT_EQUIPAMENTOS_NOME,
                    'valor_padrao'      => false,
                    'readonly'          => false,
                    'aviso'             => '',
                    'formtipo'          => 'input',
