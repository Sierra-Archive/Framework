<?php
final Class Comercio_Visita_DAO extends Framework\App\Dao 
{
    protected $id;
    protected $clientepossivel;
    protected $responsavel;
    protected $data;
    protected $data_proximo;
    protected $endereco;
    protected $cep;
    protected $pais;
    protected $estado;
    ...
    public static function Gerar_Colunas() {
        return Array(
            ...
            Array(
                ...
                'edicao'            => Array(
                    'Nome'              => __('Responsável pelo Contato'),
                    'valor_padrao'      => FALSE,
                    'readonly'          => FALSE,
