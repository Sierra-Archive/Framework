<?php
final Class Comercio_Certificado_AuditoriaPeriodica_DAO extends Framework\App\Dao 
{
    protected $id;
    protected $idcliente;
    protected $idproduto;
    ...
    public static function Gerar_Colunas(){
        return Array(
            Array(
                ...
                'mysql_titulo'      => 'idproposta',
                'mysql_tipovar'     => 'int', //varchar, int, 
                'mysql_tamanho'     => 11,
                'mysql_null'        => false,
                'mysql_default'     => false,
                'mysql_primary'     => false,
                'mysql_estrangeira' => 'CCP.id|CCP.num_proposta', // chave estrangeira
                'mysql_autoadd'     => false,
                'mysql_comment'     => false,
                'mysql_inside'      => false, // Funcao Executada quando o dado for inserido no banco de dados
                'mysql_outside'     => false, // Funcao Executada quando o dado for retirado no banco de dados
