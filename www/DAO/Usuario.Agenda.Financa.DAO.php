<?php
final Class Usuario_Agenda_Financa_DAO extends Framework\App\Dao 
{
    protected $id;
    protected $valor;
    protected $data;
    ...
    protected $categoria;
    protected $local;
    protected $categoria_sub;
    
    protected static $objetocarregado     = false;     protected static $mysql_colunas       = false;     protected static $mysql_outside       = Array();     protected static $mysql_inside        = Array(); public function __construct() {  parent::__construct(); } public static function Get_Nome(){
        return MYSQL_USUARIO_AGENDA_FINANCAS;
    }
    /**
    ...
    public static function Gerar_Colunas(){
        return Array(
            Array(
                ...
                'mysql_default'     => false,
                'mysql_primary'     => false,
                'mysql_estrangeira' => 'C.id|C.nome|CA.mod_acc=Agenda_financas', // chave estrangeira
                'mysql_autoadd'     => false,
                'mysql_comment'     => false,
                'mysql_inside'      => false, // Funcao Executada quando o dado for inserido no banco de dados
                'mysql_outside'     => false, // Funcao Executada quando o dado for retirado no banco de dados
                'perm_copia'        => false, //permissao funcional necessaria para campo 2 todos 
                'linkextra'          => 'categoria/Admin/Categorias_Add/Agenda_financas',
                'edicao'            => Array(
                    'Nome'              => 'Categoria',
                    'valor_padrao'      => false,
                    'readonly'          => false,
                    ...
                    'select'             => array(
                        'class'             => 'obrigatorio',
                        'infonulo'          => 'Escolha um Tipo de Finança',
                    )
                )
            ),Array(
                'mysql_titulo'      => 'local',
