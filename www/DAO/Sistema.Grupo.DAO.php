<?php
final Class Sistema_Grupo_DAO extends Framework\App\Dao 
{
    protected $id;
    protected $categoria;
    protected $nome;
    protected $valor_matricula;
    ...
    public static function Gerar_Colunas() {
        return Array(
            ...
            Array(
                ...
                'mysql_outside'     => false, // Funcao Executada quando o dado for retirado no banco de dados
                'perm_copia'        => false, //permissao funcional necessaria para campo 2 todos 
                'linkextra'         => '',//categoria/Admin/Categorias_Add/usuario_grupo', //0 ninguem, 1 admin, 2 todos 
                'edicao'            => Array(
                    'Nome'              => __('Tipo de Grupo'),
                    'valor_padrao'      => false,
                    'readonly'          => false,
                    'aviso'             => '',
                    'formtipo'          => 'select',
            ...
            Array(
                'mysql_titulo'      => 'valor_mensalidade',
                'mysql_tipovar'     => 'float', //varchar, int, 
                'mysql_tamanho'     => 30,
                'mysql_null'        => true,  // nulo ?
                'mysql_default'     => 0, // valor padrao
            ...
            Array(
                'TabelaLinkada'     => Array(
                    'Pai'               => 'SG', // TABELA que vai manipular a conexao
                    'Tabela'            => 'SGP', // TABELA de LINK A SER CONECTADA
                    'valor_padrao'      => false, // ID DO PAI
                    'Nome'              => __('Permissões do Grupo'), // Nome no FOrmulario
