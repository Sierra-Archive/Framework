<?php
final Class Transporte_Estrada_DAO extends Framework\App\Dao 
{
    protected $id;
    protected $nome;
    protected $data;
    ...
    protected static $objetocarregado     = false;     protected static $mysql_colunas       = false;     protected static $mysql_outside       = Array();     protected static $mysql_inside        = Array(); public function __construct() {  parent::__construct(); } public static function Get_Nome(){
        return MYSQL_TRANSPORTE_ESTRADA;
    }
    /**
        ...
        return Array(
            ...
            Array(
                ...
                'edicao'            => Array(
                    ...
                    'select'            => array(
                        'class'             => 'obrigatorio',
                        'infonulo'          => 'Escolha se a dica de estrada fica ou não em destaque',
                        'opcoes'            => array(
                            array(
                                'value'         =>  '0',
                                'nome'          => 'Não'
            ...
            Array(
                ...
                'edicao'            => Array(
                    ...
                    'select'            => array(
                        'class'             => 'obrigatorio',
                        'infonulo'          => 'Escolha se a dica de estrada está ou não ativada',
                        'opcoes'            => array(
                            array(
                                'value'         =>  '1',
                                'nome'          => 'Ativado'
