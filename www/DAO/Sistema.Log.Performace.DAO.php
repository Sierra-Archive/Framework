<?php
final Class Sistema_Log_Performace_DAO extends Framework\App\Dao 
{
    protected $chave;
    protected $nome;
    protected $tempo_total;
    protected $tempo_media;
