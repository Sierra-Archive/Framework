<?php
final Class Comercio_Fornecedor_DAO extends Framework\App\Dao 
{
    protected $id;
    protected $categoria;
    protected $fisica;
    ...
    protected $site; // responsavel tecnico
    protected $banco;
    protected $agencia;
    protected $conta;
    
    protected static $objetocarregado     = false;     protected static $mysql_colunas       = false;     protected static $mysql_outside       = Array();     protected static $mysql_inside        = Array(); public function __construct() {  parent::__construct(); } public static function Get_Nome(){
        return MYSQL_COMERCIO_FORNECEDOR;
    }
    /**
    ...
    public static function Gerar_Colunas(){
        return Array(
            ...
            Array(
                ...
                'mysql_estrangeira' => 'C.id|C.nome|CA.mod_acc=comercio_Fornecedor', // chave estrangeira     ligacao|apresentacao|condicao
                'mysql_autoadd'     => false,
                'mysql_comment'     => false,
                'mysql_inside'      => false, // Funcao Executada quando o dado for inserido no banco de dados
                'mysql_outside'     => false, // Funcao Executada quando o dado for retirado no banco de dados
                'perm_copia'        => false, //permissao funcional necessaria para campo 2 todos 
                'linkextra'          => 'categoria/Admin/Categorias_Add/comercio_Fornecedor', //0 ninguem, 1 admin, 2 todos 
                'edicao'            => Array(
            ...
            Array(
                ...
                'edicao'            => Array(
                    ...
                    'aviso'             => '',
                    'formtipo'          => 'select',
                    'change'            => 'Control_Layoult_Form_Campos_Trocar(\'#nome,#nome_contato,#cpf,#cnpj,#cnpj_insc,#razao_social,#nomefantasia\')',
                    'select'            => array(
                        'opcoes'            => array(
                            array(
                                'value'         =>  '1',
            ...
            Array(
                ...
                'form_change'       => 'CF', // CHANGE PARA EXTRANGEIRAS -> Sigla Tabela Pai / Sigla Tabela Atual ou false
                'mysql_autoadd'     => false,
                'mysql_comment'     => false,
                'mysql_inside'      => false, // Funcao Executada quando o dado for inserido no banco de dados
                'mysql_outside'     => false, // Funcao Executada quando o dado for retirado no banco de dados
