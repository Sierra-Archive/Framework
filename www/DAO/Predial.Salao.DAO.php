<?php
final Class Predial_Salao_DAO extends Framework\App\Dao 
{
    protected $id;
    protected $categoria;
    protected $nome;
    ...
    public static function Gerar_Colunas() {
        return Array(
            ...
            Array(
                ...
                'mysql_estrangeira' => 'C.id|C.nome|CA.mod_acc=predial_Salao', // chave estrangeira     ligacao|apresentacao|condicao
                'mysql_autoadd'     => FALSE,
                'mysql_comment'     => FALSE,
                'mysql_inside'      => FALSE, // Funcao Executada quando o dado for inserido no banco de dados
                'mysql_outside'     => FALSE, // Funcao Executada quando o dado for retirado no banco de dados
                'perm_copia'        => FALSE, //permissao funcional necessaria para campo 2 todos 
                'linkextra'         => 'categoria/Admin/Categorias_Add/predial_Salao', //0 ninguem, 1 admin, 2 todos 
                'edicao'            => Array(
                    'Nome'              => __('Tipo do Local'),
                    'valor_padrao'      => FALSE,
                    'readonly'          => FALSE,
                    'aviso'             => '',
                    'formtipo'          => 'select',
            ...
            Array(
                ...
                'linkextra'         => '', //0 ninguem, 1 admin, 2 todos 
                'edicao'            => Array(
                    'Nome'              => __('Nome do Local de Reserva'),
                    'valor_padrao'      => FALSE,
                    'readonly'          => FALSE,
            ...
            Array(
                ...
                'linkextra'         => '', //0 ninguem, 1 admin, 2 todos 
                'edicao'            => Array(
                    'Nome'              => __('Preço do Local de Reserva'),
                    'Mascara'           => 'Real',
                    'valor_padrao'      => FALSE,
                    'readonly'          => FALSE,
                    'aviso'             => '',
