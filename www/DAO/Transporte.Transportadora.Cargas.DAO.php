<?php
final Class Transporte_Transportadora_Cargas_DAO extends Framework\App\Dao 
{
    protected $id;
    ...
    protected static $objetocarregado     = false;     protected static $mysql_colunas       = false;     protected static $mysql_outside       = Array();     protected static $mysql_inside        = Array(); public function __construct() {  parent::__construct(); } public static function Get_Nome(){
        return MYSQL_TRANSPORTE_TRANSPORTADORA_CARGAS;
    }
    /**
        ...
        return Array(
            ...
            Array(
                ...
                'edicao'            => Array(
                    ...
                    'select'             => array(
                        'class'             => 'obrigatorio',
                        'infonulo'          => 'Escolha uma Transportadora',
                    )
                )
            ),Array(
