<?php
final Class Usuario_Social_Ficou_Comentario_DAO extends Framework\App\Dao 
{
    protected $id;
    protected $ficada;
    ...
    public static function Get_Nome(){
        return MYSQL_USUARIO_SOCIAL_FICOU_COMENTARIO;
    }
    /**
    ...
    public static function Gerar_Colunas(){
        return Array(
            ...
            Array(
                ...
                'mysql_estrangeira' => 'USF.id|USF.obs', // chave estrangeira     ligacao|apresentacao|condicao
                'mysql_autoadd'     => false,
                'mysql_comment'     => false,
                'mysql_inside'      => false, // Funcao Executada quando o dado for inserido no banco de dados
                'mysql_outside'     => false, // Funcao Executada quando o dado for retirado no banco de dados
                'perm_copia'        => false, //permissao funcional necessaria para campo 2 todos 
                'linkextra'          => 'usuario_social/Persona/Ficou_Add', //0 ninguem, 1 admin, 2 todos 
                'edicao'            => Array(
                    'Nome'              => 'Ficada',
                    'valor_padrao'      => false,
                    'readonly'          => false,
