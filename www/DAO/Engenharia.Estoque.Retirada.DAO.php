<?php
final Class  Engenharia_Estoque_Retirada_DAO extends Framework\App\Dao 
{
    protected $id;
    protected $idproduto;
    protected $idempreendimento;
    protected $qnt;
    protected $data;
    protected $obs;
        ...
        return Array(
            ...
            Array(
                ...
                'edicao'            => Array(
                    ...
                    'select'             => array(
                        'class'             => 'obrigatorio',
                        'infonulo'          => 'Escolha um Produto para Retirar',
                    )
                )
            ),Array(
