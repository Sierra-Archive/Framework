<?php
final Class Simulador_Assistir_DAO extends Framework\App\Dao 
{
    protected $token;
    protected $simulador;
    protected $pergunta;
    ...
    protected static $objetocarregado     = false;     protected static $mysql_colunas       = false;     protected static $mysql_outside       = Array();     protected static $mysql_inside        = Array(); public function __construct() {  parent::__construct(); } public static function Get_Nome() {
        return MYSQL_SIMULADOR_ASSISTIR;
    }
    /**
    ...
    public static function Gerar_Colunas() {
        return Array(
            ...
            Array(
                ...
                'mysql_default'     => 0, // valor padrao
                'mysql_primary'     => TRUE,  // chave primaria
                'mysql_estrangeira' => 'SiPR.id|SiPR.nome|SiPR.pergunta={pergunta}', // chave estrangeira     ligacao|apresentacao|condicao
                'mysql_autoadd'     => FALSE,
                'mysql_comment'     => FALSE,
                'mysql_inside'      => FALSE, // Funcao Executada quando o dado for inserido no banco de dados
                'mysql_outside'     => FALSE, // Funcao Executada quando o dado for retirado no banco de dados
                'perm_copia'        => FALSE, //permissao funcional necessaria para campo 2 todos 
                'linkextra'         => 'Simulador/Resposta/Respostas_Add', //0 ninguem, 1 admin, 2 todos 
                'edicao'            => Array(
                    'Nome'              => __('Resposta'),
                    'valor_padrao'      => FALSE,
                    'readonly'          => FALSE,
