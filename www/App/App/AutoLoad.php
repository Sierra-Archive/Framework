...
function Erro_Formatar( $errno, $errstr, $errfile, $errline, $previ = '', $trace = false) {
    ...
    $content .= '<tr valign=\'top\'><td><b>'.__('Error').'</b></td><td><pre>'.htmlspecialchars($errstr, ENT_QUOTES).'</pre></td></tr>';
    $content .= '<tr valign=\'top\'><td><b>'.__('Errno').'</b></td><td><pre>'.htmlspecialchars($errno, ENT_QUOTES).'</pre></td></tr>';
    $content .= '<tr valign=\'top\'><td><b>'.__('Arquivo').'</b></td><td>'.htmlspecialchars($errfile, ENT_QUOTES).'</td></tr>';
    $content .= '<tr valign=\'top\'><td><b>'.__('Linha').'</b></td><td>'.htmlspecialchars($errline, ENT_QUOTES).'</td></tr>';
    $content .= '<tr valign=\'top\'><td><b>'.__('Previa').'</b></td><td><pre>'.htmlspecialchars($previ, ENT_QUOTES).'</pre></td></tr>';
    $content .= '<tr valign=\'top\'><td><b>'.__('Extra').'</b></td><td><pre>-----------</pre></td></tr>';
    $content .= '<tr valign=\'top\'><td><b>'.__('Logado').'</b></td><td><pre>'.\Framework\App\Session::get(SESSION_ADMIN_LOG).'</pre></td></tr>';
    $content .= '<tr valign=\'top\'><td><b>'.__('Url').'</b></td><td><pre>'.$url.'</pre></td></tr>';
    $content .= '<tr valign=\'top\'><td><b>'.__('POST').'</b></td><td><pre>'.htmlspecialchars(print_r($_POST,true)).'</pre></td></tr>';
    $content .= '</tbody></table>';
    
    if (is_array($trace)) {
        $content .= '<h2>'.__('Traço').'</h2>';
